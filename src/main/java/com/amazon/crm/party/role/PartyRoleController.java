...
public class PartyRoleController {
    ...
    @CrossOrigin
    @RequestMapping(method = RequestMethod.GET, value = "/amazon-crm-party-role", produces = "text/plain")
    ...
    @CrossOrigin
    @RequestMapping(method = RequestMethod.GET, value = "/amazon-crm-party-role-chaining", produces = "application/json")
    ...
    @CrossOrigin
    @RequestMapping(method = RequestMethod.GET, value = "/amazon-crm-party-role-secured", produces = "text/plain")
